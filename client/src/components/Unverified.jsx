    ...
    return(
        <div className="main">
            ...
            <div className="unverifiedHead">               
                <h3 className="eventText"><div className="sqr"></div><div className="dec"><img src={document} alt="." /></div>Nepatvirtinti renginiai</h3>
            </div>
            {Ids().map((post, index) => (
                ...
                {adminPanel === index && (
                    <div> 
                        <h3 className="adminText"><div className="adminsqr"></div><div className="dec"><img src={adminlogo} alt="." /></div>Administratoriaus nustatymai</h3>
